...
# fgbg = cv2.bgsegm.createBackgroundSubtractorMOG() Otro modelo para probar
...
while True:
    ...
    # Abajo izqda, Arriba izqda, Arriba derecha, Abajo derecha
    ...
    # cv2.imshow("frame", cv2.resize(frame,(frame.shape[1],frame.shape[0])))
